...
<body>
  ...
  <div class="form-group" text-center">
    ...
    <label for="exampleFormControlSelect2">Gender:</label><span style="color: red !important; display: inline; float: none;">*</span>
    ...
    <div class="form-group">
    <label for="exampleFormControlSelect2">Country:</label><span style="color: red !important; display: inline; float: none;" required>*</span>
    ...
    <!-- Message -->
    <div class="form-group">
      <label for="message">Message:</label><span style="color: red !important; display: inline; float: none;">*</span>
